...
{
    soundscripts\_snd_playsound::snd_play_at( "bog_b_final_wall_exp_debris", ( 4779.0, -3910.0, -16.0 ) );
}

aud_final_tank_exp_debris()
{
    soundscripts\_snd_playsound::snd_play_at( "final_tank_exp_debris", ( 4859.0, -4353.0, 76.0 ) );
}
