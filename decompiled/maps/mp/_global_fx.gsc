...
main()
{
    ...
    maps\mp\_global_fx_code::global_fx( "me_streetlight_01_FX_origin", "fx/misc/lighthaze_bog_mp" );
    ...
    maps\mp\_global_fx_code::global_fx( "me_dumpster_fire_FX_origin", "fx/fire/firelp_med_pm_bog_mp", undefined, undefined, "fire_dumpster_medium" );
    maps\mp\_global_fx_code::global_fx( "barrel_fireFX_origin", "fx/fire/firelp_small_pm_bog_mp", undefined, undefined, "fire_barrel_small" );
    maps\mp\_global_fx_code::global_fx( "barrel_fireFX_origin_mp_bog", "fx/fire/firelp_small_pm_bog_mp", undefined, undefined, "fire_barrel_small" );
}
