...
tv_station_visionset()
{
    ...
    maps\_utility::_id_7F00( "armada_tvs", 3 );
}
...
play_flickering_light()
{
    ...
    thread maps\_lighting::_id_5D3A( "flicker_1", 0, var_0, var_1, undefined, undefined, 0.5, 1, 0.005, 0.05, undefined, var_2, 100 );
    thread maps\_lighting::_id_5D3A( "flicker_2", 0, var_0, var_1, undefined, undefined, 0.01, 5, 0.005, 0.05, undefined, var_2, 100 );
}
