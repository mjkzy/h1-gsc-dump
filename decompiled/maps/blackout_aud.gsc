...
aud_open_door_meeting()
{
    ...
    {
        wait 1.5;
        common_scripts\utility::array_thread( level.aud.first_door_open_trigger, common_scripts\utility::_id_97CE );
    }
...
aud_gaz_open_door_rescue()
{
    ...
    {
        wait 1.5;
        level.aud.gaz_door_open_trigger common_scripts\utility::_id_97CE();
    }
...
disable_azm_trigger_before_meeting_door_open()
{
    ...
    common_scripts\utility::array_thread( level.aud.first_door_open_trigger, common_scripts\utility::_id_97CC );
}

disable_azm_trigger_before_gaz_open_door_for_rescue()
{
    level.aud.gaz_door_open_trigger = getent( "flag_before_gaz_open_door_for_rescue", "script_noteworthy" );
    level.aud.gaz_door_open_trigger common_scripts\utility::_id_97CC();
}
