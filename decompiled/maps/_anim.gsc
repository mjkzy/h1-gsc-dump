...
anim_addmodel( var_0, var_1 )
{
    ...
    var_0.scriptmodel[var_2] = spawn( "script_model", ( 0.0, 0.0, 0.0 ) );
...
get_to_transition_point( var_0, var_1, var_2, var_1, var_3, var_4 )
{
    ...
    var_1.start_point = animscripts\cover_arrival::getarrivalstartpos( var_1, var_2, var_3, var_1.approach_number );
    var_6 = lengthsquared( animscripts\utility::lookuptransitionanim( "cover_trans_dist", var_3, var_1.approach_number ) );
