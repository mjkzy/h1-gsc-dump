...
prestigedoublexp()
{
    character\character_dead_russian_loyalist_a::prestigedoublexp();
    character\character_dead_russian_loyalist_b::prestigedoublexp();
    character\character_dead_russian_loyalist_c::prestigedoublexp();
    precacheitem( "ak47" );
