...
doplanestrike( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( var_13 == "allies" )
        var_12 setmodel( "h1_vehicle_av8b_harrier" );
    else
        var_12 setmodel( "h1_vehicle_mig29" );
...
callstrike_planesound( var_0, var_1 )
{
    ...
    var_0 thread common_scripts\utility::play_loop_sound_on_entity( "h1_ks_veh_mig29_close_loop" );
    ...
    var_0 notify( "stop soundh1_ks_veh_mig29_close_loop" );
    var_0 thread common_scripts\utility::play_loop_sound_on_entity( "h1_ks_veh_mig29_dist_loop" );
...
givehardpointitem( var_0 )
{
    ...
    var_1 = maps\mp\_utility::getkillstreakindex( var_0 );
    self setclientomnvar( "ks_icon0", var_1 );
    return 1;
}
