...
init()
{
    ...
    {
        if ( !issubstr( tablelookupbyrow( "mp/statstable.csv", var_3, 2 ), "weapon_" ) )
            continue;

        if ( tablelookupbyrow( "mp/statstable.csv", var_3, 51 ) != "" )
            continue;
...
turret_monitoruse()
{
    if ( getdvarint( "scr_game_deleteturrets", 0 ) )
    {
        self delete();
        return;
    }
...
watchweaponinspection()
{
    ...
    for (;;)
    {
        ...
        if ( var_1 == "weapon_pistol" || maps\mp\gametypes\_class::isperkequipment( var_0 ) )
        {
