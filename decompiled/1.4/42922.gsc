...
ch_kills( var_0 )
{
    ...
    if ( maps\mp\_utility::ismeleemod( var_9 ) && !var_13 && !var_12 )
    {
        if ( !issubstr( var_30, "riotshield" ) )
        {
            ...
            var_34 = var_0.victim.anglesondeath[1];
            var_35 = var_1.anglesonkill[1];
            var_36 = angleclamp180( var_34 - var_35 );
    ...
    if ( issubstr( var_9, "MOD_IMPACT" ) && !var_13 && !var_12 )
    {
        ...
        var_37 = getweaponattachments( var_0.sweapon );
        var_30 = maps\mp\_utility::getbaseweaponname( var_0.sweapon );

        foreach ( var_39 in var_37 )
        {
            if ( maps\mp\_utility::isstrstart( var_39, "glmwr" ) )
    ...
    if ( issubstr( var_9, "MOD_GRENADE" ) || issubstr( var_9, "MOD_PROJECTILE" ) || issubstr( var_9, "MOD_EXPLOSIVE" ) && !var_13 && !var_12 )
    {
        if ( isdefined( var_0.victim.explosiveinfo["damageTime"] ) && var_0.victim.explosiveinfo["damageTime"] == var_10 )
        {
            ...
            var_41 = var_10 + "_" + var_0.victim.explosiveinfo["damageId"];

            if ( !isdefined( var_1.explosivekills[var_41] ) )
                var_1.explosivekills[var_41] = 0;

            var_1 thread clearidshortly( var_41 );
            var_1.explosivekills[var_41]++;

            if ( var_31 == "fraggrenadeshort" )
            {
                if ( var_1.explosivekills[var_41] == 3 )
            ...
            {
                if ( var_1.explosivekills[var_41] == 2 )
    ...
    else if ( var_37.size > 0 )
    {
        if ( !issubstr( var_9, "MOD_MELEE" ) )
        {
            foreach ( var_47 in var_37 )
            {
                if ( issubstr( var_47, "reflexmwr" ) )
                {
                    var_1 processchallenge( "ch_reddot_" + var_30 );
                    continue;
                }

                if ( issubstr( var_47, "silencermwr" ) )
                {
                    var_1 processchallenge( "ch_silencer_" + var_30 );
                    continue;
                }

                if ( issubstr( var_47, "acogmwr" ) )
...
monitorsprintdistance()
{
    ...
    for (;;)
    {
        ...
        self.totalgamesprintdist = self.totalgamesprintdist + self.sprintdistthissprint;

        if ( maps\mp\_utility::_hasperk( "specialty_longersprint" ) )
        {
            if ( int( self.totalgamesprintdist ) >= 31680 )
            {
