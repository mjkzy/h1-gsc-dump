...
{
    return maps\mp\_utility::invirtuallobby() && isdefined( level.forcecustomclassloc );
}

cac_getweapon( var_0, var_1, var_2 )
{
    if ( usevirtuallobbyfunction() )
        return getcacplayerdata( var_2, level.forcecustomclassloc, var_0, "weaponSetups", var_1, "weapon" );
...
{
    if ( usevirtuallobbyfunction() )
        return getcacplayerdata( var_2, level.forcecustomclassloc, var_0, "weaponSetups", var_1, "camo" );
    else if ( isdefined( level.forcecustomclassloc ) )
...
{
    if ( usevirtuallobbyfunction() )
        return getcacplayerdata( var_2, level.forcecustomclassloc, var_0, "weaponSetups", var_1, "reticle" );
    else if ( isdefined( level.forcecustomclassloc ) )
...
{
    if ( usevirtuallobbyfunction() )
        return getcacplayerdata( var_2, level.forcecustomclassloc, var_0, "weaponSetups", var_1, "kit", "attachKit" );
    else if ( isdefined( level.forcecustomclassloc ) )
...
{
    if ( usevirtuallobbyfunction() )
        return getcacplayerdata( var_2, level.forcecustomclassloc, var_0, "weaponSetups", var_1, "kit", "furnitureKit" );
    else if ( isdefined( level.forcecustomclassloc ) )
...
{
    if ( usevirtuallobbyfunction() )
        return getcacplayerdata( var_1, level.forcecustomclassloc, var_0, "meleeWeapon" );
    else if ( isdefined( level.forcecustomclassloc ) )
...
{
    if ( usevirtuallobbyfunction() )
        return getcacplayerdata( var_2, level.forcecustomclassloc, var_0, "perkSlots", var_1 );
    else if ( isdefined( level.forcecustomclassloc ) )
...
{
    if ( usevirtuallobbyfunction() )
        return getcacplayerdata( var_2, level.forcecustomclassloc, var_0, "equipment", var_1 );
    else if ( isdefined( level.forcecustomclassloc ) )
...
{
    var_1 = tablelookup( "mp/furniturekits.csv", 1, var_0, 0 );
    var_1 = int( var_1 );
    return var_1;
}
...
getloadout( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    else if ( issubstr( var_1, "lobby" ) )
    {
        ...
        var_33 = self.loadouts[var_32][var_6];
    ...
    else
    {
        ...
        if ( isai( self ) )
        {
            var_43 = self.pers["rank"] >= 29 && common_scripts\utility::cointoss();
            var_44 = self.pers["rank"] >= 19 && common_scripts\utility::cointoss();
        }
        else
        {
    ...
    if ( var_28 != "none" )
        var_33.meleeweaponname = var_28 + "_mp";
    else
...
isfurniturekitunlocked( var_0, var_1 )
{
    ...
    var_2 = tablelookup( "mp/furniturekits.csv", 1, var_1, 2 );
...
{
    var_3 = tablelookup( "mp/furniturekits.csv", 1, var_0, 0 );
...
iscamounlocked( var_0, var_1, var_2 )
{
    if ( isdefaultunlocked() )
        return 1;
    ...
    if ( !self isitemunlocked( var_4, var_2 ) )
        return 0;
