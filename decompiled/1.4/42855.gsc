...
wait_start_firingrange( var_0 )
{
    ...
    thread maps\mp\_vl_base::virtual_lobby_set_class( 0, "lobby" + var_0.currentselectedclass, 1, 1 );
    maps\mp\_utility::updatesessionstate( "playing" );
    var_0 setclienttriggervisionset( "mp_vlobby_room_firerange_h1", 0 );
    var_0 lightsetforplayer( "mp_vlobby_room_firerange_h1" );
    ...
    foreach ( var_5 in var_3 )
    {
        ...
        if ( maps\mp\gametypes\_class::isvalidequipment( var_7 ) || maps\mp\gametypes\_class::isvalidoffhand( var_7 ) || maps\mp\gametypes\_class::isperkequipment( var_7 ) )
        {
            var_0 thread monitor_grenade_count( var_5 );
            continue;
        }

        if ( maps\mp\gametypes\_class::isvalidprimary( var_6 ) || maps\mp\gametypes\_class::isvalidsecondary( var_6 ) || maps\mp\gametypes\_class::isperkprimary( var_7 ) )
        {
            var_0 thread monitor_weapon_ammo_count( var_5 );
            continue;
        }
    }
}
...
playermonitorweaponforlane()
{
    ...
    for (;;)
    {
        ...
        if ( var_3 == "pistol" )
        {
            var_4 = playergetprimarynotpistol();
            var_3 = weaponclass( var_4 );
        }
