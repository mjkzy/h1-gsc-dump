...
playerkilled_internal( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11 )
{
    ...
    if ( isdefined( var_2.uselaststandparams ) )
    {
        ...
        if ( !level.teambased || ( !isdefined( var_1 ) || !isplayer( var_1 ) || var_1.team != var_2.team || var_1 == var_2 ) )
        {
            var_21 = var_1 == var_2;
    ...
    if ( maps\mp\gametypes\_killcam::killcamvalid( var_2, var_36 ) && !var_55 )
    {
        ...
        var_2 maps\mp\gametypes\_killcam::killcam( var_0, var_42, var_43, var_44, var_5, var_33, var_34, var_35, var_54 + var_19, var_8, var_47, var_56, maps\mp\gametypes\_gamelogic::timeuntilroundend(), var_1, var_2, var_4, "normal", var_46, var_45 );
    }
    ...
    var_57 = maps\mp\_utility::getgametypenumlives();
    var_58 = self.pers["lives"];
