...
setup_camparams()
{
    ...
    else if ( getdvarint( "virtualLobbyReady", 0 ) == 0 )
...
playerupdatecamera()
{
    ...
    if ( var_1.newmode != var_1.mode )
    {
        ...
        else if ( var_1.newmode == "game_lobby" )
        {
            ...
            if ( var_1.mode != "cac" )
                maps\mp\_vl_avatar::show_avatars();
...
setavatarweaponroomdofdelayed( var_0 )
{
    ...
    var_2 = 1;
    var_3 = 120;
    var_4 = level.camparams.dof_time;
    ...
    self setphysicaldepthoffield( var_2, var_3, var_4, var_4 * 2 );
}
...
set_avatar_dof( var_0 )
{
    var_1 = 4;
    var_2 = 100;
    var_3 = level.camparams.dof_time;
    self setphysicaldepthoffield( var_1, var_2, var_3, var_3 * 2 );
}
...
vl_dof_based_on_focus_weap_cac( var_0 )
{
    ...
    var_2 = -0.200097 * var_0 + 19.836;
    var_2 = fstop_clamp( var_2 );
    self setphysicaldepthoffield( var_2, var_0, var_1, var_1 * 2 );
}
