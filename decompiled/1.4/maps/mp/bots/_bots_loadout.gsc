...
bot_allowed_to_try_last_loadout()
{
    if ( maps\mp\_utility::is_true( self.bot_pick_new_loadout_next_spawn ) )
        return 0;
    else if ( !isdefined( self.botlastloadout ) )
        return 0;
...
bot_loadout_class_callback( var_0 )
{
    ...
    if ( isdefined( self.botlastloadout ) && maps\mp\_utility::is_true( var_0 ) )
        return self.botlastloadout;

    var_4 = !isdefined( self.botlastloadoutdifficulty ) || self.botlastloadoutdifficulty == var_2;
    var_5 = !isdefined( self.botlastloadoutpersonality ) || self.botlastloadoutpersonality == var_3;
    var_6 = 0;
    ...
    self.bot_cur_loadout_num++;
    self.botlastloadout = var_1;
    self.botlastloadoutdifficulty = var_2;
    self.botlastloadoutpersonality = var_3;
