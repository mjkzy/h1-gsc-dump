...
getnextspectateclient()
{
    ...
    for ( var_1 = common_scripts\utility::mod( var_0 + 1, 18 ); var_1 != var_0; var_1 = common_scripts\utility::mod( var_1 + 1, 18 ) )
    {
        if ( self _meth_857E( var_1 ) )
            break;
    }
    ...
    if ( var_1 != var_0 )
    {
        foreach ( var_3 in level.players )
        {
            if ( var_3 getentitynumber() == var_1 )
                return var_3;
        }
    }
