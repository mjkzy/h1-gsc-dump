...
treadfx_override()
{
    maps\_treadfx::setallvehiclefx( "script_vehicle_blackhawk", "fx/treadfx/heli_dust_armada", "h1r_blackhawk_wind" );
    maps\_treadfx::setvehiclefx( "script_vehicle_blackhawk", "water", "fx/treadfx/heli_water", "h1r_blackhawk_wind" );
    maps\_treadfx::setallvehiclefx( "script_vehicle_m1a1_abrams", "vfx/treadfx/tread_dust_tanks", undefined );
}
